...
pub const ENDPOINTS: &[EndpointDef] = &[
    ...
    EndpointDef {
        ...
        description: "List exact local legacy Wiki/Web snapshots available for explicit import",
        category: "stores",
        request: RequestSpec::None,
    },
    EndpointDef {
        ...
        description: "Import a reviewed local legacy Wiki/Web snapshot into its canonical shared group store",
        category: "stores",
