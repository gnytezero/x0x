...
PUBSUB_SHA = "2f019ae3c17a73197ff7c48b5078caa2d03b669b7c0b724e30d2037e44e868b6"
...
def derive(record, lock_bytes):
    ...
    require(len(packages) == 1 and packages[0]["version"] == "0.5.80" and packages[0]["checksum"] == PUBSUB_SHA, "PRODUCER_PIN_MISMATCH")
